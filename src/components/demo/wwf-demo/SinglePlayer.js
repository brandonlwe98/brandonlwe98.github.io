...
const SinglePlayer = () => {
	...
	const handleKeys = (e) => {
		//session storage stores boolean as string
		if((sessionStorage.getItem('gameOver') === false) || gameOver === false || gameOver ==='false'){
		...
		else Toastr.error('Game is over, please restart')
	...
	return (
		...
		>
			...
			<Box className='flex justify-center'>
				<Button size='lg' id='btnRestart' className='my-10 gap-2'
					onClick={
						(e) => {
							e.preventDefault()
							setGameOver(true)
